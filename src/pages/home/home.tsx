...
<>
    ...
    <div className="container-wrapper grid grid-col-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 pb-80 gap-y-3 gap-x-3">
        {/* card multiple */}
        <div className="relative text-center lg- h-48   ">
            <img className="absolute w-full h-full object-cover rounded-lg"
                ...
                alt="" />
            <div
                className="relative flex items-center align-middle justify-center mt-12">
                <div className="text-center items-center text-white bg-opacity-70 rounded-lg">
